...
const opts = {
  ...
  longitude: -96.825,
	zoom: 9,
	//mapStyle: 'mapbox://styles/ryanveitch/ciwe3cjc700022psgigusm29i', //dark
	//mapStyle: 'mapbox://styles/ryanveitch/ciwe3fm5a00252plkli0r8x96', //light
	mapStyle: 'mapbox://styles/ryanveitch/ciwe4ko53000a2psgj2cmknd1', //light
  mapboxApiAccessToken: 'pk.eyJ1IjoicnlhbnZlaXRjaCIsImEiOiJjaXdhNjUwZmowNGszMnlvNXFsOHpncWVtIn0.V2MN0i2MVN6zOi9AzdNVkQ'
};
...
export class GeoPage extends React.Component {
	render(){
