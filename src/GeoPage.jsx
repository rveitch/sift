...
import {
  ...
  ViewSwitcherHits, MultiMatchQuery, SearchkitComponent, PageSizeSelector, Select, CheckboxFilter, TermQuery, BoolShould, BoolMust, BoolMustNot, RangeQuery, HierarchicalRefinementFilter
} from "searchkit";
		    ...
		    <Layout>
		      ...
		      <LayoutBody>
		        <SideBar>
							...
							<HierarchicalRefinementFilter field="address_levels" title="State" id="state" startLevel={2}/>
